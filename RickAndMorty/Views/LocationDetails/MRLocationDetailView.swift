...
class RMLocationDetailView: UIView {
    ...
    public weak var delegete: RMLocationDetailViewDelegate?
...
extension RMLocationDetailView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let section = viewModel.cellViewModels
        let sectionType = section[indexPath.section]
        ...
        case .characters:
            ...
            delegete?.rmLocationDetailView(self, didSelect: character)
        }
    }
}
